...
class LoginPage(BasePage):
    def __init__(self, page: Page):
        ...
        self.email_input = page.get_by_test_id("login-form-email-input").locator('//div//input')
        ...
        self.wrong_email_or_password_alert = wrong_email_or_password_alert = page.get_by_test_id(
    ...
    def check_visible_not_email_or_password_allert(self):
